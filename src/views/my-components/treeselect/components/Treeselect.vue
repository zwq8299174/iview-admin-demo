<template>
  <div
    ...
    ref="wrapper" :style="{width:width+'px'}">
    <div class="vue-treeselect__control">
      <component :is="ValueComponent" ref="value" />
      <div v-if="shouldShowClearIcon" class="vue-treeselect__x iconfont" :title="multiple ? clearAllText : clearValueText" @mousedown="handleMouseDownOnClear">&#xe638;</div>
